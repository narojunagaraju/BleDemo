package com.example.bledemo.presentation
...
import com.example.bledemo.permissions.PermissionsUtil
import com.example.bledemo.permissions.SystemBroadcastReceiver
...
fun TemperatureHumidityScreen(
    ...
    val permissionState = rememberMultiplePermissionsState(permissions = PermissionsUtil.permissions)
    ...
    Box(
        ...
        Column(
            ...
            if (bleConnectionState == ConnectionState.CurrentlyInitializing) {
                ...
                Button(onClick = { viewModel.initializeConnection() }) {
